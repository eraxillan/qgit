...
public:
    ...
    virtual ~UnbufferedTemporaryFile();
    bool unbufOpen();
};

UnbufferedTemporaryFile::~UnbufferedTemporaryFile() {
}

UnbufferedTemporaryFile::UnbufferedTemporaryFile(QObject* p) : QTemporaryFile(p) {
}

bool UnbufferedTemporaryFile::unbufOpen() {
