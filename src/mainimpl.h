...
*/
#ifndef QGIT_MAINIMPL_H_INCLUDED
#define QGIT_MAINIMPL_H_INCLUDED
...
public:
    MainImpl(const QString& curDir = "", QWidget* parent = nullptr);
...
private:
    ...
    void setRepository(SCRef wd, bool = false, bool = false, const QStringList* = nullptr, bool = false);
    ...
    template<class X> QList<X*>* getTabs(QWidget* tabPage = nullptr);
    template<class X> X* firstTab(QWidget* startPage = nullptr);
    void openFileTab(FileView* fv = nullptr);
...
#endif // QGIT_MAINIMPL_H_INCLUDED
