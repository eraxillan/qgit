...
void FileHistory::setEarlyOutputState(bool b) {

    earlyOutputCnt = (b ? earlyOutputCntBase : -1);
}

void FileHistory::setAnnIdValid(bool b) {
...
int FileHistory::columnCount(const QModelIndex &) const { return 5; }
...
const QStringList FileHistory::fileNames() const {
