...
ExceptionManager *ExceptionManager::em() {
...
ExceptionManager::SetIt ExceptionManager::findExcp(ThrowableSet& ts, const SetIt& startIt, int excpId) {
...
ExceptionManager::Exception::Exception(int ex, bool v) : excpId(ex), verbose(v), isRaised(false) {
