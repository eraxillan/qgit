...
InputDialog::WidgetItem::WidgetItem() : widget(nullptr) {
...
public:
    RefNameValidator(bool allowEmpty=false, QObject *parent = nullptr)
        : QValidator(parent)
        , invalid("[ ~^:\?*[]")
...
bool InputDialog::validate() {
    ...
    bool result = true;
    QMap<QString, const QValidator*>::const_iterator it=validators.begin(), end=validators.end();
