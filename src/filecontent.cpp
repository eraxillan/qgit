...
public:
    FileHighlighter(FileContent* fc);
...
FileHighlighter::FileHighlighter(FileContent *fc) : QSyntaxHighlighter(fc), f(fc) {

}

void FileHighlighter::highlightBlock(const QString &p) {
...
bool FileContent::isFileAvailable() const {
