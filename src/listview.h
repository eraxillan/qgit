...
*/
#ifndef QGIT_LISTVIEW_H_INCLUDED
#define QGIT_LISTVIEW_H_INCLUDED
...
public:
    ...
    int filterRows(bool, bool, SCRef = QString(), int = -1, ShaSet* = nullptr);
...
#endif // QGIT_LISTVIEW_H_INCLUDED
